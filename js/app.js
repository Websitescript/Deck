...
function wireWindowControls() {
  ...
  document.getElementById("ctrl-close").addEventListener("click", () => {
    // If the terminal's open, treat this the same as its own ✕ — closing
    // it is almost certainly what someone clicking any ✕ wants. Only show
    // the joke when there's nothing open for it to plausibly mean.
